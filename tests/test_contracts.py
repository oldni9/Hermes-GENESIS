...
from hermes.execution.contracts import ExecutionEngine  # import directly from contracts
...
class DummyEngine:
    ...
    def execute(
        self, request: ExecutionRequest, context: ExecutionContext | None = None
    ) -> dict[str, Any]:
...
def test_dummy_engine_protocol():
    engine = DummyEngine()
    # Since ExecutionEngine is a Protocol with @runtime_checkable, isinstance should work
    # if the dummy implements the protocol.
