...
# ✓ Legacy layer preserved exactly.
# ✓ AI layer constructed.
# ✓ Orchestrator layer constructed.
#   - ProviderSelector uses AIRegistry.
#   - AIOrchestrator uses AIManager, ProviderSelector, ResponseProcessor, RetryPolicy.
# ✓ AIPipeline uses AIOrchestrator.
# ✓ Conversation layer components constructed.
# ✓ No existing methods removed.
# ✓ No existing behavior changed.
# ✓ No redesign of Bootstrap.
# ✓ ExecutionPlan now includes use_cache and cache_ttl.
# ✓ RetryPolicy uses correct jitter and total_time.
# ✓ Exception handling preserves KeyboardInterrupt.
# ✓ ResponseProcessor mutates AIResponse in place (acceptable).
# ✓ All files are complete and merge-ready.