...
class AdapterValidator:
    ...
    def validate(
        ...
        if not adapter.id.strip():
            ...
            raise AdapterValidationError("Adapter id cannot be empty.")

        if not adapter.name.strip():

            raise AdapterValidationError("Adapter name cannot be empty.")
        ...
        if adapter.priority < 0:
            ...
            raise AdapterValidationError("Priority cannot be negative.")
